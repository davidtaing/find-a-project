...
export default function Home() {
  return (
    <main
      className="m-h-screen prose prose-xl  prose-stone w-full max-w-full dark:prose-invert "
      aria-label="Home Page"
    >
      <section className="mx-auto grid h-96 max-w-6xl grid-cols-12 gap-6">
      ...
      <section className="mx-auto mb-20 grid max-w-6xl grid-cols-12 gap-6">
        ...
        <article className="col-span-6 h-80 rounded-md border border-stone-200 bg-stone-100 dark:border-stone-800 dark:bg-stone-800">
          Project 1
        </article>
        <article className="col-span-6 h-80 rounded-md border border-stone-200 bg-stone-100 dark:border-stone-800 dark:bg-stone-800">
          Project 2
